...
import { validationSchema } from "@/validate/propiedadSchema";
...
const submit = handleSubmit(async (values) => {
  ...
  return router.push({ name: "admin-propiedades" });
});
</script>
  ...
  <v-card max-width="800" flat class="mx-auto my-10">
    ...
    <v-form class="mt-10">
      ...
      <div class="my-5">
        ...
        <img v-if="image" class="my-50" :src="image" alt="" />
        <img v-else class="my-50" :src="propiedad?.imagen" alt="" />
      </div>
